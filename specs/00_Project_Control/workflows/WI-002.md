...
## Source Material
softkit-input/changes/applied/CR-001-script-location-and-interactive-work-item.md;
...
## Approval Boundaries
Status: approved. Usuário confirmou e aprovou este ciclo. Aprovação por ciclo inclui mudança do caminho canônico, wrappers
...
Work item: WI-002. QA pelo mesmo executor será identificado.
