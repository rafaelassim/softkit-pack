...
## Source Material
softkit-input/changes/applied/CR-003.md;
...
## Approval Boundaries
Aprovado pelo usuário. Instalação de agentes/ferramentas e inicialização por templates, sem
...
Bootstrap instalador, instruções atualizadas, testes e evidências. Work item: WI-004. Exemplo previsto:
