...
## Source Material
softkit-input/changes/applied/CR-002-artifact-routing-and-selection.md e fonte original;
...
## Approval Boundaries
Aprovado pelo usuário nesta conversa. Escopo limitado a work-item e change-request, sem dependência nova.
...
explicitamente identificado. Work item: WI-003.
